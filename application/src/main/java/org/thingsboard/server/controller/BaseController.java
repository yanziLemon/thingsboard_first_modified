...
public abstract class BaseController {
    ...
    //我自己加的
    @Autowired
    protected KvdesService kvdesService;
...
//    (1/4)接口
//    Kvdes checkKvdesEName(String eName){
//        try{
//
//            Kvdes kvdes = kvdesService.getKvdesByEName(eName);
//            checkNotNull(kvdes, "Kvdes with eName [" + eName + "] is not found");
//            return kvdes;
//        }catch (Exception e) {
//
//            e.printStackTrace();
