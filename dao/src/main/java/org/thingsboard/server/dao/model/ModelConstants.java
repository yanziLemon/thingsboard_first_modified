...
public class ModelConstants {
    ...
    /**
     * Cassandra kvdes constants.
     * 我自己加的
     */
    public static final String KVDES_ID_PROPERTY = "id";
    public static final String KVDES_COLUMN_FAMILY_NAME = "kvdes";
    public static final String KVDES_TYPE_PROPERTY= "type";
    public static final String ATT_TYPE_PROPERTY = "att_type";
    public static final String KVDES_IDENTIFICATION_PROPERTY = "att_identification";
    public static final String KVDES_NAME_PROPERTY = "att_name";
    public static final String KVDES_ACCURACY_PROPERTY = "att_accuracy";
    public static final String KVDES_UNIT_PROPERTY = "att_unit";
    public static final String ATT_READ_ONLY = "att_read_only";
    public static final String KVDES_DESCRIBE_PROPERTY= "att_describe";
    public static final String KVDES_GROUP_PROPERTY= "att_group";
    public static final String KVDES_ENAME_PROPERTY= "e_name";
